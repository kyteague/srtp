...
func (s *SessionSRTCP) OpenWriteStream() (rtcp.WriteStream, error) {
...
func (s *SessionSRTCP) OpenReadStream(SSRC uint32) (rtcp.ReadStream, error) {
...
func (s *SessionSRTCP) AcceptStream() (rtcp.ReadStream, uint32, error) {
